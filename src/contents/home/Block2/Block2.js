...
export default function Block2() {
  ...
  return ( 
    ...
    <Box   sx={{display:'flex',justifyContent:'center',gap:{xs:'0px',sm:'20px',md:'25px'},flexDirection:{xs:'column',sm:'column',md:'row'},paddingTop:{xs:'0px',sm:'20px',md:'30px'},alignItems:'center'}}>

      <Box sx={{display:'flex',gap:{xs:'0px',sm:'20px',md:'20px'}}}>
   <Box sx={{padding:{xs:'10px',sm:'20px',md:'0'}}}>
   
      <CardBox onClick={() => handleClick('tshirts')}>
    ...
    <Box sx={{height:{xs:'40%',sm:'50%',md:'auto'},width:{xs:'100%',sm:'100%',md:'200px'},display:'flex',background:'transparent',justifyContent:'center',gap:'10px',padding:'0px'}}>
   <Box sx={{display:'flex',flexDirection:'column'}}>
      ...
      <CardBox onClick={() => handleClick('shirts')}>
    ...
    <Box sx={{display:'flex',flexDirection:'column'}}>
      ...
      <CardBox onClick={() => handleClick('jeans')}>
      ...
      <CardBox onClick={() => handleClick('jacket')}>
      ...
      <Box sx={{display:'flex',flexDirection:'column'}}>
          ...
          <Typography sx={{fontSize:{xs:'15px',sm:'20px',md:'20px'},fontWeight:'500'}}>Jackets</Typography>
      ...
      <CardBox onClick={() => handleClick('joggers')}>
    ...
    <Box sx={{display:'flex',flexDirection:'column'}}>
      ...
      <CardBox onClick={() => handleClick('footwear')}>
