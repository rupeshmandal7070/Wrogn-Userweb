...
import { deleteOrder, getOrder } from '@/src/redux/slices/orders'
...
<Typography sx={{fontWeight:'600',fontSize:'16px',padding:'15px'}}>Orders</Typography>
<Divider/>
...
<Box sx={{display:'flex',borderBottom:'1px solid rgba(0,0,0,0.1)',padding:'10px',justifyContent:'space-between'}}>
        ...
        <Typography onClick={() => handleClick(cart.id)} sx={{cursor:'pointer'}}>Order Details</Typography>
                    ...
                    <Box sx={{display:'flex',gap:'20px',marginTop:'10px',}}>
                        ...
                        <Box>
                           <Typography>{ cart.productId && cart.productId.title && cart.productId.title.longTitle}</Typography>
